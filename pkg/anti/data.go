...
// DetectionPattern 通用检测特征结构
type DetectionPattern struct {
	Pattern     string
	Description string
}

// RootFilePatterns ROOT文件路径检测特征
...
// RootAppPatterns ROOT管理应用包名检测特征
